        ...
        <div className="p-5 sm:p-6 space-y-4">
          ...
          <label
            ...
            className={`flex flex-col items-center justify-center w-full min-h-[160px] rounded-xl border-2 border-dashed cursor-pointer transition-all duration-300 ${
              dragOver ? 'border-indigo-400/60 bg-cyan-500/10' : 'border-white/12 bg-white/4 hover:border-cyan-500/35 hover:bg-white/7'
            }`}
          >
            {preview ? (
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <button onClick={uploadImage} disabled={uploading} className="relative group/u">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-[#0369a1] to-[#0284c7] rounded-xl opacity-60 blur group-hover/u:opacity-100 transition duration-300" />
                  <div className="relative flex items-center gap-2 px-4 py-1.5 bg-[#020b18] rounded-xl border border-white/10">
