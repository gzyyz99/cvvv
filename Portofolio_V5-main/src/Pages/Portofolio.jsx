...
const defaultProjects = [
  {
    ...
    Features: [
      ...
      "Real-time Web Search & Media Player",
...
const techStacks = [
  ...
  { icon: "networking.svg", language: "Networking" },
  { icon: "linux.svg", language: "Linux / OS" },
...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Gunakan default projects jika supabase offline / belum ada tabel
      setProjects(prev => (prev && prev.length > 0 ? prev : defaultProjects));
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#020b18] overflow-hidden" id="Portofolio">
