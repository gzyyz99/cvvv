    ...
    >
        ...
        <div className="flex items-start gap-3">
            {comment.profile_image ? (
                ...
                <div className={`p-2 rounded-full text-indigo-400 group-hover:bg-cyan-500/30 transition-colors ${
            ...
            <div className="flex-grow min-w-0">
                <div className="flex items-center justify-between gap-4 mb-2">
                    <div className="flex items-center gap-2">
                        ...
                        {isPinned && (
                            <span className="px-2 py-0.5 text-xs bg-cyan-500/20 text-indigo-300 rounded-full">
                                Admin
                            </span>
                        )}
                    </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
                    ...
                    {imagePreview ? (
                        ...
                        <div className="w-full">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-cyan-500/20 text-indigo-400 hover:bg-cyan-500/30 transition-all border border-dashed border-cyan-500/50 hover:border-cyan-500 group"
                            >
