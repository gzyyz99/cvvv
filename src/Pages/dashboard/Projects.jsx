...
const InputField = ({
  ...
  <div className="space-y-1.5">
    ...
    <input
      ...
      required={required}
      className="w-full bg-[#0d0d22] border border-white/10 rounded-xl px-4 py-2.5 text-gray-200 placeholder-gray-600 text-sm outline-none focus:border-cyan-500/60 focus:ring-1 focus:ring-indigo-500/20 transition-all"
    />
  </div>
);
        ...
        {project.TechStack?.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mb-3">
            {project.TechStack.map((t) => (
              <span
                key={t}
                className="px-2 py-0.5 rounded-full bg-cyan-500/15 border border-cyan-500/25 text-indigo-300 text-xs"
              >
                {t}
              </span>
            ))}
        ...
        <div className="mt-auto flex items-center justify-between gap-2 pt-2 border-t border-white/8">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-cyan-500/25 text-indigo-400 hover:bg-cyan-500/10 text-xs transition-colors"
            >
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-[#0d0d22] border border-white/10 rounded-xl px-4 py-2.5 text-gray-200 placeholder-gray-600 text-sm outline-none focus:border-cyan-500/60 focus:ring-1 focus:ring-indigo-500/20 transition-all resize-none"
          />
        </div>
      ...
      <div className="flex justify-end gap-2 pt-1">
        ...
        <button type="submit" disabled={uploading} className="relative group/s">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#0369a1] to-[#0284c7] rounded-xl opacity-60 blur group-hover/s:opacity-100 transition duration-300" />
          <div className="relative flex items-center gap-2 px-5 py-2 bg-[#020b18] rounded-xl border border-white/10">
            {uploading ? (
      ...
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <div className="relative w-9 h-9 bg-[#020b18] rounded-xl border border-white/15 flex items-center justify-center">
        ...
        >
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#0369a1] to-[#0284c7] rounded-xl opacity-50 blur group-hover:opacity-80 transition duration-300" />
          <div className="relative flex items-center gap-2 px-4 py-2.5 bg-[#020b18] rounded-xl border border-white/10">
